...
class Embed:
    def __init__(self, title: str|None = None, description: str|None = None, url: str|None = None, color: int = 0x000000, image:EmbedImage|None = None):
        self.title = title
    ...
    def modify(self, title: str|None = None, description: str|None = None, url: str|None = None, color: int|None = None, image:EmbedImage|None = None):
        if title != None:
            self.title = title
        if description != None:
            self.description = description
